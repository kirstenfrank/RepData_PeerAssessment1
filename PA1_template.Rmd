...
```{r} 
## look up average for that interval and put it in meansteps.
activity$meansteps<-stepstime$avesteps[stepstime$interval==as.numeric(activity$interval)]

activity$imputesteps<-ifelse(activity$steps==NA, activity$meansteps,activity$steps)
```
